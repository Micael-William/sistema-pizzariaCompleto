...
<body>
	<div id="header">
		<div>
			<ul class="first">
				...
				<li><a href="menu.php">Everyday Menu</a></li>
			</ul>
			<div>
	...
	<div id="content">
		<div>
			<div>
				<div>
					<h1><a href="index.php">Liberteri Italiano is located in:</a></h1>
				...
				<span><a href="index.php"><img src="images/map.jpg" alt="Image"></a></span>
			</div>
			<div>
				<div>
					<h1><a href="index.php">Liberteri Italiano is located in:</a></h1>
